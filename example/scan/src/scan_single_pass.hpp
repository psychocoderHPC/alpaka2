...
namespace alpaka::example::scan
{
     ...
     * the improvement from Lichterman, but using a single-pass version by Merrill and Garland, see:
    ...
    public:
        ALPAKA_FN_ACC void operator()(
            ...
            concepts::IMdSpan auto flags,
            concepts::IMdSpan auto metaData,
            concepts::IMdSpan auto frameCounter) const
        {
        ...
        concepts::IMdSpan auto outputVec)
    {
        ...
        // std::cout << "type: " << onHost::getStaticName<FlagType<DeviceType>>() << std::endl;
